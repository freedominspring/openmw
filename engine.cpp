...
void OMW::Engine::prepareEngine()
{
    ...
    // Controller-aware windows initialise their prompts and focus rules during construction.
    // Build those affordances up front; the input manager will enable or disable them at runtime
    // based on actual controller presence.
    const bool configuredControllerMenus = Settings::gui().mControllerMenus;
    ...
    Settings::gui().mControllerMenus.set(configuredControllerMenus);
